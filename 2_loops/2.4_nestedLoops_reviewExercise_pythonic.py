...
def wished_double():
    ...
    def function_for_looping():
        """Calculates some tasks then hands the content to the enclosing/outer function above"""
...
# All in all content can be stored in a local variable
...
overallcontent = wished_double()

# Print only the local variable (containing the content of the 'wished double'-function)
