...
def multiply(x,y):
    ...
    for i in range(1,times+1):
        # re-use the duplication content again within itself
        num = num * 2
        # print all: first, intermediate, last contents
        print(num)
    return num

# no need to type "print() here !  Because printing a content is already included in the function's body
multiply(x,y)
